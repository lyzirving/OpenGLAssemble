...
#undef LOCAL_TAG
#endif
#define LOCAL_TAG "ContinuousLineRenderer"

ContinuousLineRenderer::ContinuousLineRenderer(const char *name)
...
ContinuousLineRenderer::~ContinuousLineRenderer() = default;

bool ContinuousLineRenderer::initProgram() {
...
void ContinuousLineRenderer::drawLines(Point2d *points, uint32_t count, uint32_t lineWidth, uint32_t color) {
    ...
    for(uint32_t i = 1; i < count; i++) {
        Polygon2d polygon{};
        VectorHelper::segToContinuousPolygon(&polygon, points, i - 1, count, lineWidth);
...
void ContinuousLineRenderer::initHandler() {
...
void ContinuousLineRenderer::initCoordinate() {
    glGenBuffers(2, mVbo);
}

void ContinuousLineRenderer::initBuffer() {
    //empty implementation for this case
}

void ContinuousLineRenderer::onBeforeInit() {}

void ContinuousLineRenderer::onPostInit(bool success) {}

void ContinuousLineRenderer::release() {
